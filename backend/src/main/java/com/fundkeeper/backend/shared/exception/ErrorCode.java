...
public enum ErrorCode {
    ...
    TRANSACTION_BEFORE_SNAPSHOT(HttpStatus.CONFLICT),
    BUY_STATE_CONFLICT(HttpStatus.CONFLICT),
    SELL_ALREADY_OPEN(HttpStatus.CONFLICT),
    SELL_STATE_CONFLICT(HttpStatus.CONFLICT),
    SELL_AMOUNT_EXCEEDS_POSITION(HttpStatus.UNPROCESSABLE_CONTENT),
    SELL_SHARES_EXCEED_POSITION(HttpStatus.UNPROCESSABLE_CONTENT),
    IDEMPOTENCY_CONFLICT(HttpStatus.CONFLICT),
    IMPORT_BATCH_NOT_FOUND(HttpStatus.NOT_FOUND),
    IMPORT_NOT_READY(HttpStatus.CONFLICT),
